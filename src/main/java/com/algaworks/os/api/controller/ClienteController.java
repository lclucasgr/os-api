...
import com.algaworks.os.domain.service.CadastroClienteService;
...
public class ClienteController {
	...
	public List<Cliente> listar()
	{
		...
		//return clienteRepository.findByNome("Claudia");
	}
	
	@GetMapping("/{clienteId}")
	public ResponseEntity<Cliente> buscar(@PathVariable Long clienteId){
		Optional<Cliente> cliente = clienteRepository.findById(clienteId); //findById metodo nativo
